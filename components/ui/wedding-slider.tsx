      ...
      const slides: SlideData[] = [
        {
          title: "Детство",
          description:
            "Когда-то мы были совсем маленькими и ещё не знали друг друга...",
          media: sharedPhotos.childhood,
        },
        {
          title: "Первая встреча",
          description:
            "А потом судьба свела нас — и всё изменилось навсегда",
          media: sharedPhotos.firstMeeting,
        },
        {
          title: "Весь мир под ногами",
          description:
            "Вместе мы объехали полмира и каждое путешествие — новая глава",
